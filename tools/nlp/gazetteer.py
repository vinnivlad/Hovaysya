...
MY_AREA = [
    ...
    _p("Борщагівка", "my-area", "борщагів", "борщаг", "софіївська борщаг",
       "соф борщаг"),
    # `солом` rather than a list of endings: `monitoring_kyiv` writes "На центр
    # / солому", and "солому" matched none of them — his own district read as
    # merely the city centre.
    _p("Солом'янка", "my-area", "солом"),
...
OBLAST = [
    ...
    # "БЦ - біла церква, далеко", his words. Abbreviated in every mention.
    _p("Біла Церква", "oblast", "бц", "біла церкв", "білоцерків", "білої церкв", "білу церкв"),
